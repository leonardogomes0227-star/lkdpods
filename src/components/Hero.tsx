  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-neutral-950 p-6 sm:p-8 md:p-12 text-white shadow-2xl border border-neutral-800 my-4 mx-4 sm:mx-6">
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        {/* Card Destaque */}
        {featuredProduct && (
          <div className="w-full md:w-80 bg-neutral-900 border border-neutral-800 rounded-3xl p-5 sm:p-6 shadow-2xl transition-all hover:border-emerald-500/50 group">
